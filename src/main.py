...
def main():
    """
    Пользовательский интерфейс для работы с API платформ hh и sj
    ...
    select_platforms = input(
        'Введите платформу для поиска: HeadHunter, Superjob или введите "ALL" для поиска по всем платформам: ')
    search_query = input("Введите ключевое слово вакансии: ")
    if select_platforms.lower() == 'hh' or select_platforms.lower() == 'headhunter':
